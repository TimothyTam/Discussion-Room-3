...
namespace UnitTesting
{
	...
	//Call before each TEST_METHOD. Should not have anything special to put here.
	...
	public:
		...
		TEST_CLASS_INITIALIZE(generateRequireResources) {
			...
			Such that		-- Follow Table		-- Followed by Table
			follows(1, 2)	-- 1 | 2			-- 2 | 1
